<template>
	<u-popup :maskCloseAble="maskCloseAble" mode="bottom" :popup="false" v-model="value" length="auto" :safeAreaInsetBottom="safeAreaInsetBottom" @close="close" :z-index="uZIndex">
      ...
      <view class="u-picker-header" @touchmove.stop.prevent="" v-if="mode == 'region'">
      	...
      	>
      		<u-icon name="close" size="35" color="#000"></u-icon>
      	</view>
      </view>
			<view class="u-picker-header" @touchmove.stop.prevent="" v-else>
				<view class="u-btn-picker u-btn-picker--tips" 
					:style="{ color: cancelColor }" 
					hover-class="u-opacity" 
					:hover-stay-time="150" 
			...
			<view class="u-picker-body">
				<picker-view v-if="mode == 'region'" :value="valueArr" @change="change" :indicator-style="indicatorStyle" indicator-class="active-picker" class="u-picker-view" @pickstart="pickstart" @pickend="pickend">
					...
					<picker-view-column v-if="!reset && params.city">
						<view class="u-column-item" v-for="(item, index) in citys" :key="index">
							<view class="u-line-1" :class="{'active':valueArr[1]==index}">{{ item.label }}</view>
						</view>
					</picker-view-column>
					<picker-view-column v-if="!reset && params.area">
						<view class="u-column-item" v-for="(item, index) in areas" :key="index">
							<view class="u-line-1" :class="{'active':valueArr[2]==index}">{{ item.label }}</view>
						</view>
					</picker-view-column>
				</picker-view>
      ...
      <view class="comfirm-btn">
        <view class="btn" @tap.stop="getResult('confirm')">
          确定
        </view>
      </view>
...
@import './util/style.components.scss';
